        ...
        <div class="FLEX flex-col mt-5 ml-4 mr-4">
         ...
         <div id="modal" class="fixed hidden inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            ...
            <div class="bg-white mx-4 md:mx-auto w-full max-w-lg rounded p-8">
              ...
              <!-- Modal body -->
              <p class="text-sm md:text-base">This is the modal body. You can add your content here.</p>
              <!-- Modal footer -->
              <div class="flex justify-end mt-4">
                <button class="btn btn-gray mr-4" onclick="closeModal()">Cancel</button>
                <button class="btn btn-green" onclick="closeModal()">OK</button>
              </div>
            </div>
          </div>
